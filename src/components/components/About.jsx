...
const About = () => (
  <section id="about" className="bg-gradient-to-b from-gray-900 to-black py-20 relative overflow-hidden">
    ...
    >
      ...
      <p className="text-lg mb-10 max-w-3xl mx-auto text-gray-300 text-center">
    ...
    >
      ...
      <p className="text-lg mb-8 max-w-2xl mx-auto text-gray-300 text-center">
    ...
    <motion.div
      ...
      className="p-4 container mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 mt-16 relative z-10"
    >
      {/* Value Card 1 */}
      <motion.div
